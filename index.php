...
<body>
    <?php
        $array_google=[
            [
                'domanda'=> "<h3>Come state implementando la recente decisione della Corte di giustizia dell'Unione europea (CGUE) relativa al diritto all'oblio?</h3> <br>",
            ...
            [
                'domanda'=> "<h3>Come fa Google a proteggere la mia privacy e a tenere le mie informazioni al sicuro?</h3> <br>",
            ...
            [
                'domanda'=> "<h3>Perché il mio account è associato a un paese?</h3> <br>",
                'risposta'=> "<p>Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose:</p> <br>
                                <ol>
            ...
            [
                'domanda'=> "<h3>Come faccio a rimuovere informazioni su di me dai risultati di ricerca di Google?</h3><br>",
            ...
            [
                'domanda'=> "<h3>Quando faccio clic sui risultati della Ricerca Google, le mie chiavi di ricerca vengono inviate ai siti web?</h3><br>",
