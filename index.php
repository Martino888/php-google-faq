...
<body>
    <?php
        $array_google=[
            [
                'argomento'=> "<h1>Come state implementando la recente decisione della Corte di giustizia dell'Unione europea (CGUE) relativa al diritto all'oblio?</h1>",
            ...
            [
                'argomento'=> "<h1>Come fa Google a proteggere la mia privacy e a tenere le mie informazioni al sicuro?</h1>",
